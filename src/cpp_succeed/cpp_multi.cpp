 ...
 */
#include "/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk/usr/include/sys/syslimits.h"
#include "stdio.h"
#include <fstream>
#include <locale>
class bbase {
public:
  void set() const { printf("bbase %s\n", __FUNCTION__); }
  void bset() const { printf("bbase %s\n", __FUNCTION__); }
  int val3 = 3;
